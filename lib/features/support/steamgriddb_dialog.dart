...
class SteamGridDBDialog extends ConsumerStatefulWidget {
  ...
  static void show(BuildContext context) =>
      showDialog(context: context, builder: (context) => const SteamGridDBDialog());
          ...
          SizedBox(
            ...
            child: MarkdownWidget(
              ...
              config: MarkdownConfig(
                configs: [
                  LinkConfig(
                    style: TextStyle(color: context.colorScheme.primary, decoration: TextDecoration.underline),
