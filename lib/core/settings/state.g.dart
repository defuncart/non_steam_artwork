...
String _$resizeLargeImagesControllerHash() => r'edcaf0c6ab79ec9e72d37b35ff7a0ae47c3cb3e0';

/// See also [ResizeLargeImagesController].
@ProviderFor(ResizeLargeImagesController)
final resizeLargeImagesControllerProvider = AutoDisposeNotifierProvider<ResizeLargeImagesController, bool>.internal(
  ResizeLargeImagesController.new,
  name: r'resizeLargeImagesControllerProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product') ? null : _$resizeLargeImagesControllerHash,
  dependencies: null,
  allTransitiveDependencies: null,
);

typedef _$ResizeLargeImagesController = AutoDisposeNotifier<bool>;
