...
/// Adds pattern-matching-related methods to [SteamProgram].
extension SteamProgramPatterns on SteamProgram {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _SteamProgram value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _SteamProgram() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _SteamProgram value)  $default,){
final _that = this;
switch (_that) {
case _SteamProgram():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _SteamProgram value)?  $default,){
final _that = this;
switch (_that) {
case _SteamProgram() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int appId,  String appName,  SteamProgramType programType,  DateTime lastPlayed,  File? icon,  File? cover,  File? hero,  File? logo,  LogoPosition? logoPosition,  File? banner)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SteamProgram() when $default != null:
return $default(_that.appId,_that.appName,_that.programType,_that.lastPlayed,_that.icon,_that.cover,_that.hero,_that.logo,_that.logoPosition,_that.banner);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int appId,  String appName,  SteamProgramType programType,  DateTime lastPlayed,  File? icon,  File? cover,  File? hero,  File? logo,  LogoPosition? logoPosition,  File? banner)  $default,) {final _that = this;
switch (_that) {
case _SteamProgram():
return $default(_that.appId,_that.appName,_that.programType,_that.lastPlayed,_that.icon,_that.cover,_that.hero,_that.logo,_that.logoPosition,_that.banner);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int appId,  String appName,  SteamProgramType programType,  DateTime lastPlayed,  File? icon,  File? cover,  File? hero,  File? logo,  LogoPosition? logoPosition,  File? banner)?  $default,) {final _that = this;
switch (_that) {
case _SteamProgram() when $default != null:
return $default(_that.appId,_that.appName,_that.programType,_that.lastPlayed,_that.icon,_that.cover,_that.hero,_that.logo,_that.logoPosition,_that.banner);case _:
  return null;
...
/// Adds pattern-matching-related methods to [LogoPosition].
extension LogoPositionPatterns on LogoPosition {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _LogoPosition value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _LogoPosition() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _LogoPosition value)  $default,){
final _that = this;
switch (_that) {
case _LogoPosition():
return $default(_that);}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _LogoPosition value)?  $default,){
final _that = this;
switch (_that) {
case _LogoPosition() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( LogoPositionType position,  double width,  double height)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LogoPosition() when $default != null:
return $default(_that.position,_that.width,_that.height);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( LogoPositionType position,  double width,  double height)  $default,) {final _that = this;
switch (_that) {
case _LogoPosition():
return $default(_that.position,_that.width,_that.height);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( LogoPositionType position,  double width,  double height)?  $default,) {final _that = this;
switch (_that) {
case _LogoPosition() when $default != null:
return $default(_that.position,_that.width,_that.height);case _:
  return null;
