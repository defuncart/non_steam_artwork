...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1946801753;
...
fn wire__crate__api__simple__generate_bytes_impl(
...
fn wire__crate__api__simple__parse_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse(
                    (move || async move { crate::api::simple::parse(api_path).await })().await,
                )
            }
        },
    )
...
impl SseDecode for Vec<crate::api::simple::SteamShortcut> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut len_ = <i32>::sse_decode(deserializer);
        let mut ans_ = vec![];
        for idx_ in 0..len_ {
            ans_.push(<crate::api::simple::SteamShortcut>::sse_decode(
                deserializer,
            ));
        }
        return ans_;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        3 => wire__crate__api__simple__generate_bytes_impl(port, ptr, rust_vec_len, data_len),
        1 => wire__crate__api__simple__init_app_impl(port, ptr, rust_vec_len, data_len),
        2 => wire__crate__api__simple__parse_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::simple::SteamShortcut
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::simple::SteamShortcut>
    for crate::api::simple::SteamShortcut
{
    fn into_into_dart(self) -> crate::api::simple::SteamShortcut {
        self
    }
}
...
impl SseEncode for Vec<crate::api::simple::SteamShortcut> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <i32>::sse_encode(self.len() as _, serializer);
        for item in self {
            <crate::api::simple::SteamShortcut>::sse_encode(item, serializer);
        }
    }
}
