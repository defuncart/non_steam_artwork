...
Future<List<SteamShortcut>> parse({required String path, dynamic hint}) =>
    RustLib.instance.api.crateApiSimpleParse(path: path, hint: hint);

Future<Uint8List> generateBytes({required List<SteamShortcut> shortcuts, dynamic hint}) =>
    RustLib.instance.api.crateApiSimpleGenerateBytes(shortcuts: shortcuts, hint: hint);
