...
/// Adds pattern-matching-related methods to [SteamShortcut].
extension SteamShortcutPatterns on SteamShortcut {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _SteamShortcut value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _SteamShortcut() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _SteamShortcut value)  $default,){
final _that = this;
switch (_that) {
case _SteamShortcut():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _SteamShortcut value)?  $default,){
final _that = this;
switch (_that) {
case _SteamShortcut() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int appId,  String appName,  String target,  String launchOptions,  String startDir,  String icon,  bool isHidden,  List<String> tags,  int lastPlayTime)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SteamShortcut() when $default != null:
return $default(_that.appId,_that.appName,_that.target,_that.launchOptions,_that.startDir,_that.icon,_that.isHidden,_that.tags,_that.lastPlayTime);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int appId,  String appName,  String target,  String launchOptions,  String startDir,  String icon,  bool isHidden,  List<String> tags,  int lastPlayTime)  $default,) {final _that = this;
switch (_that) {
case _SteamShortcut():
return $default(_that.appId,_that.appName,_that.target,_that.launchOptions,_that.startDir,_that.icon,_that.isHidden,_that.tags,_that.lastPlayTime);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int appId,  String appName,  String target,  String launchOptions,  String startDir,  String icon,  bool isHidden,  List<String> tags,  int lastPlayTime)?  $default,) {final _that = this;
switch (_that) {
case _SteamShortcut() when $default != null:
return $default(_that.appId,_that.appName,_that.target,_that.launchOptions,_that.startDir,_that.icon,_that.isHidden,_that.tags,_that.lastPlayTime);case _:
  return null;
