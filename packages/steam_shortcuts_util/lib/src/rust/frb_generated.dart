...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<List<SteamShortcut>> crateApiSimpleParse({required String path}) {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(decodeSuccessData: sse_decode_list_steam_shortcut, decodeErrorData: sse_decode_AnyhowException),
  ...
  TaskConstMeta get kCrateApiSimpleParseConstMeta => const TaskConstMeta(debugName: "parse", argNames: ["path"]);
